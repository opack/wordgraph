...
public class PuzzlePreferencesHelper {
	...
	public void setEdgeVisible(List<String> names, boolean visible) {
		for (String name : names) {
			prefs.putBoolean("edge." + name + ".visible", visible);
		}
		prefs.flush();
	}
	
	/**
	 * Indique si le lien mentionné est visible ou non
	 * @param puzzlePack
	 * @param puzzleName
	 * @param name
	 * @return
	 */
	public boolean getEdgeVisible(String name) {
		return prefs.getBoolean("edge." + name + ".visible", true);
	}

	/**
	 * Indique si la solution mentionnée est trouvée ou non
	 * @param puzzlePack
	 * @param puzzleName
	 * @param solution
	 * @return
	 */
	public boolean getSolutionFound(String solution) {
		return prefs.getBoolean("solution." + solution + ".found", false);
	}
	 ...
	 * @return
	 */
	public void setSolutionFound(String solution, boolean found) {
		prefs.putBoolean("solution." + solution + ".found", found);
		prefs.flush();
	}
